package com.superc.allihaveuse.utils.update;
...
import com.superc.allihaveuse.BuildConfig;
import com.superc.allihaveuse.R;
...
public class UpdateManager {
    ...
    AlertDialog updateDialog;// 提示信息对话框
    AlertDialog downloadDialog;// 下载对话框
...
//                ShareUtil.getInstance(context).put("DeleteTip", false);
    ...
    private void request() {
        ...
        Observable<JSONObject> jsonObjectObservable = DevRing.httpManager().getService(ApiService.class).getByClient(requestBody);
